...
class Ville:
	...
	def __init__(self):
		self.equipProduction=[ParcSolaire(nom="PVmeteo1",prod=250,effa=10,activite=50,nb=10,meteo=meteo1),ParcSolaire("PVmeteo2",prod=250,effa=10,activite=50,nb=10,meteo=meteo1),
