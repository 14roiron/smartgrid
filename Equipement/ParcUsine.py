...
class ParcUsine(Equipement):
    ...
    def __init__(self,nom="usine",prod=-3000.,effa=1000.,activite=0.,nombre=2): #consommation maximale de 3000 kW
        ...
        self.nom=nom
        self.production = [0. for i in range(144)] #consommation maximale entre 7h40 et 19h00, rampes sur 7h-7h40 et 19h-19h40
        self.production[43] = 25. #pourcentage qui multiplié par self.PROD_MAX (<0) donne la production (<0)
